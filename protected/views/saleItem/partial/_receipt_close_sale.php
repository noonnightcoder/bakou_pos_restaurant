        ...
        <tbody>
           ...
           <!-- <tr class="gift_receipt_element">
                ...
                <td colspan="1" style='text-align:right;border-top:2px solid #000000;'> 
                    ...
                    <?php /*echo Yii::app()->settings->get('site', 'currencySymbol') . number_format($totals[2],Common::getDecimalPlace(), '.', ','); */?>
                    </span>
                </td>
            </tr> 
            <tr class="gift_receipt_element">
                ...
                <td colspan="1" style='text-align:right'> 
                    <span style="font-size:15px;font-weight:bold">
                    <?php /*echo Yii::app()->settings->get('site', 'currencySymbol') . number_format($totals[1],Common::getDecimalPlace(), '.', ','); */?>
                    </span>
                </td>
            </tr> -->
