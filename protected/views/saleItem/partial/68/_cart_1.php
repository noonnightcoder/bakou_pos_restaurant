    ...
    <tr>
        ...
        <td>
            <form class="line_item_form" id="yw1" action="/index.php/saleItem/editItem?item_id=296&amp;item_parent_id=0" method="post">
                <input value="1" class="input-small input-grid alignRight form-control" id="quantity_296" placeholder="Quantity" data-id="296" data-parentid="0" maxlength="10" name="SaleItem[quantity]" type="text" />
            </form>            </td>
        <td>
