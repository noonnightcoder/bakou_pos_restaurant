...
class PriceTierZoneController extends Controller
{
	/**
	...
	{
                $model=PriceTierZone::model()->findByPk($zone_id);
	...
	{
		$dataProvider=new CActiveDataProvider('PriceTierZone');
	...
	{
		$model=new PriceTierZone('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['PriceTierZone'])) {
			$model->attributes=$_GET['PriceTierZone'];
		}
	 ...
	 * @return PriceTierZone the loaded model
	 ...
	 * @param PriceTierZone $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='price-tier-zone-form') {
